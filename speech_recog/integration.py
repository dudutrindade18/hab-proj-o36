...
from speech_recog.voice_control import VoiceControlThread
...
def setup_voice_recognition(on_command_callback=None):
    ...
    Returns:
        VoiceControlThread: Instância do controlador de voz
    """
    ...
    voice_control = VoiceControlThread(model_path=model_path, callback=on_command_callback)
    voice_control.start()
